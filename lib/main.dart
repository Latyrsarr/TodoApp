...
//           headline2: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF4F4F4F)),
...
//   List<Task> _tasks = [];
//   List<String> _selectedStatuses = ['todo', 'in process', 'done', 'bug'];
//
//   @override
//   void initState() {
//     super.initState();
...
//     List<Map<String, dynamic>> taskMaps = await _databaseHelper.getTasksByStatuses(_selectedStatuses);
//     setState(() {
...
//         children: [
//           Text('Filter by status', style: Theme.of(context).textTheme.headline2),
//           CheckboxListTile(
//             title: Text('Todo'),
...
//             value: _tempSelectedStatuses.contains('in process'),
//             onChanged: (bool? value) {
//               setState(() {
//                 if (value == true) {
//                   _tempSelectedStatuses.add('in process');
//                 } else {
//                   _tempSelectedStatuses.remove('in process');
//                 }
//               });
//             },
//           ),
...
//           ),
//           Expanded(
//             child: Text(task.title, style: Theme.of(context).textTheme.headline3),
//           ),
//         ],
//       ),
//     );
